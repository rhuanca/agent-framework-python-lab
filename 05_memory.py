# 05 — Memory with Context Providers and Session State
# Context providers inject dynamic context into each agent call.
# This example shows a provider that stores the user's name in session state
# and personalizes responses — the name persists across turns via the session.
